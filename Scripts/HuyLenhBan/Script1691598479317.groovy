...
WebUI.click(findTestObject('Page_DragonX/span_lenh'))

WebUI.click(findTestObject('Page_DragonX/span_Hy lnh'))
...
WebUI.click(findTestObject('Page_DragonX/span_Xc nhn - cancel'))

WebUI.waitForElementVisible(findTestObject('Page_DragonX/div_Lnh mua ca bn c hy thnh cngTr gipNong'), 5)
